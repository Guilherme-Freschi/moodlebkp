...
class __Mustache_0f854d2175db681875459e0f24ff8bd9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '>
';
        $buffer .= $indent . '    <div class="drawerheader mt-2 mx-2">
';
        $buffer .= $indent . '        <button class="btn btn-icon btn-primary drawertoggle btn-close-drawer--left icon-no-margin" data-toggler="drawers" data-action="closedrawer" data-target="';
        $blockFunction = $context->findInBlock('id');
        if (is_callable($blockFunction)) {
            $buffer .= call_user_func($blockFunction, $context);
        }
        $buffer .= '" data-toggle="tooltip" data-placement="';
...
';
        ...
        $buffer .= $this->section5a09cde9b210e67884b2b09e8dbf14ad($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '        ';
...
';
        ...
        $buffer .= $this->sectionF79a212b97fa7a574baadc88b357a0cb($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section5a09cde9b210e67884b2b09e8dbf14ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF79a212b97fa7a574baadc88b357a0cb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
