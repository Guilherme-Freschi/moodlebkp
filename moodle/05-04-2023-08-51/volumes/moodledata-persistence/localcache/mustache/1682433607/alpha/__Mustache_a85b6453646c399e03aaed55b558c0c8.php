...
class __Mustache_a85b6453646c399e03aaed55b558c0c8 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5c71872c19287e7d38f72d4882440678($context, $indent, $value);
        $value = $context->findDot('contents.0');
        if (empty($value)) {
...
';
    ...
    private function sectionB02aafe0b6254d65c7f3841e0f8239df(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div role="{{#viewlist}}row{{/viewlist}}{{^viewlist}}listitem{{/viewlist}}"
                        ...
                        <div class="cb-file cb-column position-relative">
                            ...
                            <a href="{{{ link }}}" class="cb-link stretched-link small" title="{{ name }}">
...
';
                ...
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '" class="cb-link stretched-link small" title="';
                $value = $this->resolveValue($context->find('name'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">
';
...
';
    ...
    private function section5c71872c19287e7d38f72d4882440678(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionB02aafe0b6254d65c7f3841e0f8239df($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $context->pop();
            }
