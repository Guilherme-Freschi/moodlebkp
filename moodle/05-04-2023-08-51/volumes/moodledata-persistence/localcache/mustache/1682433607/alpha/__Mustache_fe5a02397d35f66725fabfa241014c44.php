...
class __Mustache_fe5a02397d35f66725fabfa241014c44 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section591ceba2389efb2ab7df9803fb602153($context, $indent, $value);
...
';
    ...
    private function section591ceba2389efb2ab7df9803fb602153(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <div class="rui-topbar-customfield ml-auto d-none d-md-flex">{{{.}}}</div>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <div class="rui-topbar-customfield ml-auto d-none d-md-flex">';
                $value = $this->resolveValue($context->last(), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '</div>
';
