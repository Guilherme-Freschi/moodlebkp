...
class __Mustache_85a0438c8059a8feed05a3d5f7cb3d88 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="custom-control custom-radio custom-control-inline">
';
        $buffer .= $indent . '    <input type="radio" class="form-check-input custom-control-input" ';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
...
';
        ...
        $buffer .= ' >
';
        $buffer .= $indent . '        <label class="custom-control-label ml-1" for="';
        $value = $this->resolveValue($context->findDot('element.id'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
