...
class __Mustache_1ce48f315f8608402728bf45f9bbbfbe extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'content' => array($this, 'block49262a86904258a8f757b7dddd472e74'),
            ));
...
';
    ...
    public function block49262a86904258a8f757b7dddd472e74($context)
    {
        $indent = $buffer = '';
