...
class __Mustache_d5603e6ea06ea25b531bfe5183acb112 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</legend>
';
        $buffer .= $indent . '        <div class="border-radius p-3 border d-flex flex-column flex-md-row align-items-md-start">
';
...
';
        $buffer .= $indent . '            <div data-filterverbfor="0" class="badge badge-light my-2">';
        $value = $context->find('str');
        $buffer .= $this->sectionDb561ede0d6315d86e2a74342cf7bda9($context, $indent, $value);
        $buffer .= '</div>
';
        $buffer .= $indent . '            <div data-filterverbfor="1" class="badge badge-light my-2">';
        $value = $context->find('str');
        $buffer .= $this->section85f4b05df5694e4989051b27c526157a($context, $indent, $value);
        $buffer .= '</div>
';
        $buffer .= $indent . '            <div data-filterverbfor="2" class="badge badge-light my-2">';
        $value = $context->find('str');
