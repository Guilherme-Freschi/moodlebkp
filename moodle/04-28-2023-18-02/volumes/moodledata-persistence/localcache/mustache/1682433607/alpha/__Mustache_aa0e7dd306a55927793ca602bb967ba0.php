...
class __Mustache_aa0e7dd306a55927793ca602bb967ba0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="d-block mb-3">
';
        $buffer .= $indent . '<form class="user-competency-course-navigation wrapper-fw">
';
