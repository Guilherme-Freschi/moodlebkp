...
$string['reporttitle'] = 'Relatório de dedicação';
...
$string['timespenttasknotrunningregularly'] = 'Atenção: A tarefa de cálculo do tempo gasto não está sendo executada regularmente';
