...
class __Mustache_954804f7f637f4ec4aec92dd1b38596f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB33a369013b9622a1d5b325cf5c76a9e($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function section596a059f18a2ce5e713f2e026373e651(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                                                    <div class="rui-text--opacity d-inline-flex align-items-center flex-wrap small mb-2">
                                                        {{{course.fullname}}}
                                                    </div>
                                                    ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                                    <div class="rui-text--opacity d-inline-flex align-items-center flex-wrap small mb-2">
';
                $buffer .= $indent . '                                                        ';
...
';
    ...
    private function sectionDf45f7285ce2aefb9ecc8a5d2c3d48df(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                                        ...
                                        {{^underway}}
                                            <li
                                                ...
                                                <a data-action="view-event" data-event-id="{{id}}" href="{{url}}" title="{{name}}">
                                                    ...
                                                    {{/course.fullname}}
                                                    <div class="d-block event-time mb-1 small">{{{formattedtime}}}</div>
...
';
                    ...
                    $buffer .= $this->section596a059f18a2ce5e713f2e026373e651($context, $indent, $value);
                    $buffer .= $indent . '                                                    <div class="d-block event-time mb-1 small">';
...
';
    ...
    private function section347c25b154bd4d8de136cfe4cba16a74(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionDf45f7285ce2aefb9ecc8a5d2c3d48df($context, $indent, $value);
...
';
    ...
    private function section60fc04ce814f79e9348a4fd7e55c4e5d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $value = $context->find('hasevents');
                $buffer .= $this->section347c25b154bd4d8de136cfe4cba16a74($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
...
';
    ...
    private function sectionB33a369013b9622a1d5b325cf5c76a9e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section60fc04ce814f79e9348a4fd7e55c4e5d($context, $indent, $value);
